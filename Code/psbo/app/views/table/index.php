...
<html lang="pt-br">
  <head>
    ...
    <link rel="shortcut icon" href="<?= BASEURL; ?>/image/3.png">
          ...
          <div>
            ...
            <div class="col-md-12 text-center">
              <a href="<?= BASEURL; ?>/Form/index">
                <div class="btn btn-light mt-4 mb-4">Buat Form Hewan Ternak Sapi Potong</div>
              </a>
            </div>
          </div>
        </div>
        <div class="col p-2 bg-secondary m-2">
          <div style="color: black">
            ...
            <div class="col-md-12 text-center">
              <a href="<?= BASEURL; ?>/Form/perah">
                <div class="btn btn-dark mt-4 mb-4">Buat Form Hewan Ternak Sapi Perah</div>
              </a>
            </div>
          </div>
        </div>
          ...
          <div style="color: black">
            ...
            <div class="col-md-12 text-center">
              <a href="<?= BASEURL; ?>/Form/kambing_potong">
                <div class="btn btn-dark mt-4 mb-4">Buat Form Hewan Ternak Sapi Potong</div>
              </a>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div class="col-md-12 text-center">
              <a href="<?= BASEURL; ?>/Form/kambing_perah">
                <div class="btn btn-light mt-4 mb-4">Buat Form Hewan Ternak Kambing Perah</div>
              </a>
            </div>
          </div>
        </div>
